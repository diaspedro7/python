# Comentários em uma única linha começam com um hashtag (também conhecido por sustenido).
...
"""
cara eh uma merda comentar desse jeito:
usando o hashtag é bem melhor.
"""
